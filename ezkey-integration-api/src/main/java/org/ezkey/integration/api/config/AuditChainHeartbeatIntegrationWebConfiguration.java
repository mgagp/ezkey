 ...
 *
 * Configuration: registers peripheral heartbeat interceptor for Integration API MVC.
 */
...
/**
 * Registers the audit-chain heartbeat interceptor for Integration API peripheral endpoints.
 *
 ...
 */
@Configuration
public class AuditChainHeartbeatIntegrationWebConfiguration {
  ...
  /**
   * MVC registrar scoped to Integration API module classpath only.
   *
