 ...
 * Description: Request DTO for creating a new authentication attempt via the Integration API.
 */
...
/**
 * Request DTO for creating a new authentication attempt via the Integration API.
 *
