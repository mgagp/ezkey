 ...
 *
 * <p>
 * This configuration defines global metadata for the Swagger/OpenAPI
 * documentation of the Ezkey
 * Crypto API. The Crypto API is a development and testing utility that exposes
 * cryptographic
 ...
 *
 * <p>
 * <b>Warning:</b> This API is strictly for development and testing. It must
 * never be exposed
 * in production environments as it has no authentication and provides access to
 * sensitive
 ...
 */
@Configuration
@OpenAPIDefinition(info = @Info(title = "Ezkey Crypto API", version = "1.0.0", description = """
    ...
    - **Key Pairs**: Generate EC P-256 and Ed25519 key pairs for device simulation
    ...
    """, contact = @Contact(name = "Ezkey Team", email = "contributors@ezkey.org", url = "https://ezkey.org"), license = @License(name = "MIT License", url = "https://opensource.org/licenses/MIT")), servers = {
