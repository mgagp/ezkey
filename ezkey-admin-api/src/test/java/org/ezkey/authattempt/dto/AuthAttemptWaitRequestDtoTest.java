...
class AuthAttemptWaitRequestDtoTest{
  ...
  @Test @DisplayName("Should create record with default values")
  ...
  @Test @DisplayName("Should create record with custom values")
  ...
  @Test @DisplayName("Should validate successfully with valid values")
  ...
  @Test @DisplayName("Should fail validation when timeout is null")
  ...
  @Test @DisplayName("Should fail validation when polling is null")
  ...
  @Test @DisplayName("Should fail validation when timeout is less than minimum")
  ...
  @Test @DisplayName("Should fail validation when timeout exceeds maximum")
  ...
  @Test @DisplayName("Should fail validation when polling is less than minimum")
  ...
  @Test @DisplayName("Should fail validation when polling exceeds maximum")
  ...
  @Test @DisplayName("Should validate at minimum boundary values")
  ...
  @Test @DisplayName("Should validate at maximum boundary values")
  ...
  @Test @DisplayName("Should throw exception when polling equals timeout")
  void shouldThrowExceptionWhenPollingEqualsTimeout(){
    // Act & Assert
    IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
        () -> new AuthAttemptWaitRequestDto(30,30));

    assertEquals("Polling interval must be less than timeout duration",exception.getMessage());
  }

  @Test @DisplayName("Should throw exception when polling is greater than timeout")
  void shouldThrowExceptionWhenPollingGreaterThanTimeout(){
    // Act & Assert
    IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
        () -> new AuthAttemptWaitRequestDto(30,31));

    assertEquals("Polling interval must be less than timeout duration",exception.getMessage());
  }

  @Test @DisplayName("Should allow polling just below timeout")
  ...
  @Test @DisplayName("Should handle multiple validation errors")
  ...
  @Test @DisplayName("Should support record equality")
  ...
  @Test @DisplayName("Should provide toString representation")
  ...
  @Test @DisplayName("Should work with realistic authentication scenario")
  void shouldWorkWithRealisticScenario(){
    ...
    // Assert
    Set<ConstraintViolation<AuthAttemptWaitRequestDto>> violations = validator
        .validate(quickResponse);
    assertTrue(violations.isEmpty());
  ...
  @Test @DisplayName("Should not allow construction with both null values")
  ...
  @Test @DisplayName("Should handle edge case with null timeout and valid polling")
  ...
  @Test @DisplayName("Should handle edge case with valid timeout and null polling")
