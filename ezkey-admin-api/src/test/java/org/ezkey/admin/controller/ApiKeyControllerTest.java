 ...
 *
 * <p>
 * This test class provides minimal unit test coverage for the API key management operations to
 ...
 *
 * <p>
 * <b>Note:</b> Rate limiting is not tested due to complexity and is covered by integration tests.
 *
 * <p>
 ...
 * @since 2025
 */
@ExtendWith(MockitoExtension.class) @DisplayName("ApiKeyController Tests")
class ApiKeyControllerTest{
  ...
  @Mock
  private AdminOperationsRateLimitService adminOpsRateLimitService;
  ...
  @Nested @DisplayName("createApiKey Tests")
  class CreateApiKeyTests{

    @Test @DisplayName("Should create API key successfully and return 201 CREATED")
    void shouldCreateApiKeySuccessfully(){
      ...
      verify(apiKeyService).createApiKey(eq(123),any(EzkeyAdmin.class),eq("Test API Key"),any(),
          any());
      verify(adminOpsRateLimitService).recordCreateApiKey("admin");
    }

    @Test @DisplayName("Should return 400 BAD_REQUEST for IllegalArgumentException")
    ...
    @Test @DisplayName("Should return 409 CONFLICT for IllegalStateException")
  ...
  @Nested @DisplayName("listApiKeys Tests")
  class ListApiKeysTests{

    @Test @DisplayName("Should return list of API keys for integration")
    ...
    @Test @DisplayName("Should return empty list when no API keys found")
  ...
  @Nested @DisplayName("getApiKey Tests")
  class GetApiKeyTests{

    @Test @DisplayName("Should return API key details when found")
    ...
    @Test @DisplayName("Should return 404 NOT_FOUND when API key not found")
  ...
  @Nested @DisplayName("revokeApiKey Tests")
  class RevokeApiKeyTests{

    @Test @DisplayName("Should revoke API key successfully and return 204 NO_CONTENT")
    ...
    @Test @DisplayName("Should return 404 NOT_FOUND when API key not found for revocation")
  ...
  private ApiKeyService.ApiKeyCreationResult createMockCreationResult(){
    return new ApiKeyService.ApiKeyCreationResult(42, // apiKeyId
