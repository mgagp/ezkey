 ...
 *
 * Test Class: ApiKeyResponseDtoTest Description: Unit tests for ApiKeyResponseDto record.
 */
...
class ApiKeyResponseDtoTest{
  ...
  private static final OffsetDateTime TEST_CREATED_AT = OffsetDateTime.of(2025,10,17,10,30,0,0,
      ZoneOffset.UTC);

  private static final OffsetDateTime TEST_EXPIRES_AT = OffsetDateTime.of(2025,12,31,23,59,59,0,
      ZoneOffset.UTC);

  private static final OffsetDateTime TEST_LAST_USED_AT = OffsetDateTime.of(2025,10,17,15,45,30,0,
      ZoneOffset.UTC);
  ...
  @Test @DisplayName("Should create record with all fields for active key")
  void shouldCreateRecordWithAllFieldsForActiveKey(){
    // Arrange & Act
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,TEST_EXPIRES_AT,
        TEST_LAST_USED_AT,TEST_IP_WHITELIST,TEST_REVOKED_AT,TEST_REVOKED_BY);
  ...
  @Test @DisplayName("Should create record for revoked key with revocation details")
  void shouldCreateRecordForRevokedKeyWithRevocationDetails(){
    ...
    // Act
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,false, // inactive
        TEST_CREATED_AT,TEST_EXPIRES_AT,TEST_LAST_USED_AT,TEST_IP_WHITELIST,revokedAt,revokedBy);
  ...
  @Test @DisplayName("Should create record with minimal fields (null optionals)")
  void shouldCreateRecordWithMinimalFields(){
    // Arrange & Act
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,null, // no description
        TEST_ACTIVE,TEST_CREATED_AT,null, // no expiration
        null, // never used
  ...
  @Test @DisplayName("Should represent never-used key correctly")
  void shouldRepresentNeverUsedKeyCorrectly(){
    // Arrange & Act
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,TEST_EXPIRES_AT,null, // never
                                                                                                // used
        TEST_IP_WHITELIST,TEST_REVOKED_AT,TEST_REVOKED_BY);
  ...
  @Test @DisplayName("Should represent key without expiration correctly")
  void shouldRepresentKeyWithoutExpirationCorrectly(){
    // Arrange & Act
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,null, // no expiration
        TEST_LAST_USED_AT,TEST_IP_WHITELIST,TEST_REVOKED_AT,TEST_REVOKED_BY);
  ...
  @Test @DisplayName("Should represent key without IP restrictions correctly")
  void shouldRepresentKeyWithoutIpRestrictionsCorrectly(){
    // Arrange & Act
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,TEST_EXPIRES_AT,
        TEST_LAST_USED_AT,null, // no IP restrictions
        TEST_REVOKED_AT,TEST_REVOKED_BY);
  ...
  void shouldImplementEqualsCorrectly(){
    // Arrange
    ApiKeyResponseDto dto1 = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,TEST_EXPIRES_AT,
        TEST_LAST_USED_AT,TEST_IP_WHITELIST,TEST_REVOKED_AT,TEST_REVOKED_BY);

    ApiKeyResponseDto dto2 = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,TEST_EXPIRES_AT,
        TEST_LAST_USED_AT,TEST_IP_WHITELIST,TEST_REVOKED_AT,TEST_REVOKED_BY);

    ApiKeyResponseDto dto3 = new ApiKeyResponseDto(999, // different ID
        TEST_INTEGRATION_ID,TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,
        TEST_EXPIRES_AT,TEST_LAST_USED_AT,TEST_IP_WHITELIST,TEST_REVOKED_AT,TEST_REVOKED_BY);
  ...
  @Test @DisplayName("Should handle empty IP whitelist array")
  void shouldHandleEmptyIpWhitelistArray(){
    ...
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,TEST_EXPIRES_AT,
        TEST_LAST_USED_AT,emptyWhitelist,TEST_REVOKED_AT,TEST_REVOKED_BY);

    // Assert
    assertThat(dto.ipWhitelist()).isNotNull().isEmpty();
  }

  @Test @DisplayName("Should preserve IP whitelist order")
  void shouldPreserveIpWhitelistOrder(){
    ...
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,TEST_DESCRIPTION,TEST_ACTIVE,TEST_CREATED_AT,TEST_EXPIRES_AT,
        TEST_LAST_USED_AT,orderedWhitelist,TEST_REVOKED_AT,TEST_REVOKED_BY);

    // Assert
    assertThat(dto.ipWhitelist()).containsExactly("10.0.0.1","192.168.1.0/24","172.16.0.0/16");
  }

  @Test @DisplayName("Should represent complete revocation audit trail")
  void shouldRepresentCompleteRevocationAuditTrail(){
    ...
    // Act
    ApiKeyResponseDto dto = new ApiKeyResponseDto(TEST_API_KEY_ID,TEST_INTEGRATION_ID,
        TEST_INTEGRATION_KEY,"Compromised key - emergency revocation",false,TEST_CREATED_AT,
        TEST_EXPIRES_AT,TEST_LAST_USED_AT,TEST_IP_WHITELIST,revokedAt,revokedBy);
  ...
  @Test @DisplayName("Should contain all integration context")
