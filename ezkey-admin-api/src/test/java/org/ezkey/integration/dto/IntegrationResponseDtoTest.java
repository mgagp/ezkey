 ...
 *   <li>Nested i18n list handling</li>
 *   <li>Null handling</li>
 * </ul>
 *
...
class IntegrationResponseDtoTest {
    ...
    void shouldCreateRecordWithEmptyI18nList() {
        // Act
        IntegrationResponseDto dto = 
            new IntegrationResponseDto(TEST_ID, TEST_LOGO, TEST_ACTIVE, TEST_CREATED_AT, Collections.emptyList());
    ...
    void shouldCreateRecordWithInactiveStatus() {
        // Act
        IntegrationResponseDto dto = 
            new IntegrationResponseDto(TEST_ID, TEST_LOGO, false, TEST_CREATED_AT, Collections.emptyList());
    ...
    void shouldCreateRecordWithNullLogo() {
        // Act
        IntegrationResponseDto dto = 
            new IntegrationResponseDto(TEST_ID, null, TEST_ACTIVE, TEST_CREATED_AT, Collections.emptyList());
    ...
    void shouldHandleDifferentLogoUrlFormats() {
        ...
        for (int i = 0; i < logoUrls.length; i++) {
            IntegrationResponseDto dto = 
                new IntegrationResponseDto(i + 1, logoUrls[i], TEST_ACTIVE, TEST_CREATED_AT, Collections.emptyList());
    ...
    void shouldCreateRecordWithDifferentIds() {
        ...
        for (Integer id : ids) {
            IntegrationResponseDto dto = 
                new IntegrationResponseDto(id, TEST_LOGO, TEST_ACTIVE, TEST_CREATED_AT, Collections.emptyList());
    ...
    void shouldHandleNullActiveStatus() {
        // Act
        IntegrationResponseDto dto = 
            new IntegrationResponseDto(TEST_ID, TEST_LOGO, null, TEST_CREATED_AT, Collections.emptyList());
    ...
    private List<IntegrationI18nResponseDto> createTestI18nList() {
        return Arrays.asList(
            ...
            new IntegrationI18nResponseDto(2, "fr", "Corporation ACME", "Système d'authentification sécurisé")
        );
    }
}
