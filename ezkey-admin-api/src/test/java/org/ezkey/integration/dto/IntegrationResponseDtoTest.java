...
class IntegrationResponseDtoTest{
  ...
  private static final OffsetDateTime TEST_CREATED_AT = OffsetDateTime.of(2025,1,15,10,30,0,0,
  ...
  void shouldCreateRecordWithAllFields(){
    ...
    // Act
    IntegrationResponseDto dto = new IntegrationResponseDto(TEST_ID,TEST_LOGO,TEST_ACTIVE,
        TEST_CREATED_AT,i18nList);
  ...
  @Test @DisplayName("Should create record with empty i18n list")
  void shouldCreateRecordWithEmptyI18nList(){
    // Act
    IntegrationResponseDto dto = new IntegrationResponseDto(TEST_ID,TEST_LOGO,TEST_ACTIVE,
        TEST_CREATED_AT,Collections.emptyList());
  ...
  @Test @DisplayName("Should create record with null i18n list")
  ...
  @Test @DisplayName("Should create record with inactive status")
  void shouldCreateRecordWithInactiveStatus(){
    // Act
    IntegrationResponseDto dto = new IntegrationResponseDto(TEST_ID,TEST_LOGO,false,TEST_CREATED_AT,
  ...
  @Test @DisplayName("Should create record with null logo")
  void shouldCreateRecordWithNullLogo(){
    // Act
    IntegrationResponseDto dto = new IntegrationResponseDto(TEST_ID,null,TEST_ACTIVE,
        TEST_CREATED_AT,Collections.emptyList());
  ...
  @Test @DisplayName("Should have proper equality behavior")
  void shouldHaveProperEqualityBehavior(){
    // Arrange
    List<IntegrationI18nResponseDto> i18nList = createTestI18nList();
    IntegrationResponseDto dto1 = new IntegrationResponseDto(TEST_ID,TEST_LOGO,TEST_ACTIVE,
        TEST_CREATED_AT,i18nList);
    IntegrationResponseDto dto2 = new IntegrationResponseDto(TEST_ID,TEST_LOGO,TEST_ACTIVE,
        TEST_CREATED_AT,i18nList);
    IntegrationResponseDto dto3 = new IntegrationResponseDto(2,TEST_LOGO,TEST_ACTIVE,
        TEST_CREATED_AT,i18nList);
  ...
  @Test @DisplayName("Should have meaningful toString representation")
  ...
  @Test @DisplayName("Should handle multiple i18n entries")
  void shouldHandleMultipleI18nEntries(){
    // Arrange
    List<IntegrationI18nResponseDto> i18nList = Arrays.asList(
  ...
  @Test @DisplayName("Should preserve timezone information")
  void shouldPreserveTimezoneInformation(){
    ...
    // Act
    IntegrationResponseDto dtoUtc = new IntegrationResponseDto(1,TEST_LOGO,TEST_ACTIVE,utcTime,
        Collections.emptyList());
    IntegrationResponseDto dtoEst = new IntegrationResponseDto(2,TEST_LOGO,TEST_ACTIVE,estTime,
        Collections.emptyList());
    IntegrationResponseDto dtoJst = new IntegrationResponseDto(3,TEST_LOGO,TEST_ACTIVE,jstTime,
        Collections.emptyList());
  ...
  @Test @DisplayName("Should handle different logo URL formats")
  void shouldHandleDifferentLogoUrlFormats(){
    // Arrange
    String[] logoUrls = { "https://example.com/logo.png","http://example.com/logo.jpg",
        "/static/images/logo.svg","data:image/png;base64,iVBORw0KG...","logo.png" };

    // Act & Assert
    for (int i = 0; i < logoUrls.length; i++){
      IntegrationResponseDto dto = new IntegrationResponseDto(i + 1,logoUrls[i],TEST_ACTIVE,
          TEST_CREATED_AT,Collections.emptyList());
      assertThat(dto.logo()).isEqualTo(logoUrls[i]);
    }
  }

  @Test @DisplayName("Should support immutable i18n list")
  ...
  @Test @DisplayName("Should create record with different IDs")
  void shouldCreateRecordWithDifferentIds(){
    ...
    // Act & Assert
    for (Integer id : ids){
      IntegrationResponseDto dto = new IntegrationResponseDto(id,TEST_LOGO,TEST_ACTIVE,
          TEST_CREATED_AT,Collections.emptyList());
      assertThat(dto.id()).isEqualTo(id);
    }
  }

  @Test @DisplayName("Should handle null createdAt")
  void shouldHandleNullCreatedAt(){
    // Act
    IntegrationResponseDto dto = new IntegrationResponseDto(TEST_ID,TEST_LOGO,TEST_ACTIVE,null,
        Collections.emptyList());
  ...
  @Test @DisplayName("Should handle null active status")
  void shouldHandleNullActiveStatus(){
    // Act
    IntegrationResponseDto dto = new IntegrationResponseDto(TEST_ID,TEST_LOGO,null,TEST_CREATED_AT,
        Collections.emptyList());
  ...
  private List<IntegrationI18nResponseDto> createTestI18nList(){
    return Arrays.asList(
        ...
        new IntegrationI18nResponseDto(2,"fr","Corporation ACME",
