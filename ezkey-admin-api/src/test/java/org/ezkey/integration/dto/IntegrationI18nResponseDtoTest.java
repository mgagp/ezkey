 ...
 *
 * Test Class: IntegrationI18nResponseDtoTest Description: Unit tests for IntegrationI18nResponseDto
 * record.
 */
...
class IntegrationI18nResponseDtoTest{
  ...
  void shouldCreateRecordWithAllFields(){
    // Act
    IntegrationI18nResponseDto dto = new IntegrationI18nResponseDto(TEST_ID,TEST_LANGUAGE,TEST_NAME,
        TEST_DESCRIPTION);
  ...
  @Test @DisplayName("Should create record with null description")
  ...
  @Test @DisplayName("Should support different language codes")
  void shouldSupportDifferentLanguageCodes(){
    ...
    for (String lang : languages){
      IntegrationI18nResponseDto dto = new IntegrationI18nResponseDto(TEST_ID,lang,TEST_NAME,
          TEST_DESCRIPTION);
  ...
  void shouldHaveProperEqualityBehavior(){
    // Arrange
    IntegrationI18nResponseDto dto1 = new IntegrationI18nResponseDto(TEST_ID,TEST_LANGUAGE,
        TEST_NAME,TEST_DESCRIPTION);
    IntegrationI18nResponseDto dto2 = new IntegrationI18nResponseDto(TEST_ID,TEST_LANGUAGE,
        TEST_NAME,TEST_DESCRIPTION);
    IntegrationI18nResponseDto dto3 = new IntegrationI18nResponseDto(2,TEST_LANGUAGE,TEST_NAME,
        TEST_DESCRIPTION);
  ...
  void shouldHaveMeaningfulToStringRepresentation(){
    ...
    // Assert
    assertThat(toString).contains("IntegrationI18nResponseDto").contains(TEST_ID.toString())
        .contains(TEST_LANGUAGE).contains(TEST_NAME).contains(TEST_DESCRIPTION);
  }

  @Test @DisplayName("Should create record with French localization")
  void shouldCreateRecordWithFrenchLocalization(){
    ...
    // Act
    IntegrationI18nResponseDto dto = new IntegrationI18nResponseDto(TEST_ID,"fr",frenchName,
        frenchDescription);
  ...
  void shouldCreateRecordWithDifferentIds(){
    ...
    // Act & Assert
    for (Integer id : ids){
      IntegrationI18nResponseDto dto = new IntegrationI18nResponseDto(id,TEST_LANGUAGE,TEST_NAME,
          TEST_DESCRIPTION);
      assertThat(dto.id()).isEqualTo(id);
    }
  }

  @Test @DisplayName("Should handle empty strings")
  void shouldHandleEmptyStrings(){
    // Act
    IntegrationI18nResponseDto dto = new IntegrationI18nResponseDto(TEST_ID,"","","");
  ...
  @Test @DisplayName("Should handle special characters in content")
  void shouldHandleSpecialCharactersInContent(){
    ...
    // Act
    IntegrationI18nResponseDto dto = new IntegrationI18nResponseDto(TEST_ID,TEST_LANGUAGE,
        nameWithSpecialChars,descWithSpecialChars);
  ...
  @Test @DisplayName("Should handle null ID")
  void shouldHandleNullId(){
    // Act
    IntegrationI18nResponseDto dto = new IntegrationI18nResponseDto(null,TEST_LANGUAGE,TEST_NAME,
        TEST_DESCRIPTION);
  ...
  @Test @DisplayName("Should support long descriptions")
