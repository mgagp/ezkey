 ...
 *
 * <p><b>Responsibility:</b> This component intercepts authorization exceptions
 * thrown during
 * operation permission checks and converts them into RFC 9457 ProblemDetail
 * responses with
 ...
 *
 * <ul>
 * <li><b>AdminNotAllowedException (400):</b> Administrator operation restricted
 * (e.g.,
 * self-deactivation)
 * <li><b>AdminLimitException (400):</b> Operation violates configured admin
 * limits
 * <li><b>TenantNotAllowedException (400):</b> Tenant operation restricted
 * (e.g., system tenant
 * deactivation)
 * <li><b>TenantInactiveException (403):</b> Target tenant is inactive
 * <li><b>AuthorizationDeniedException (403):</b> Insufficient permissions
 * via @PreAuthorize
 * </ul>
 *
...
public class AuthorizationExceptionHandler extends ExceptionHandlerBase {
     ...
     *
     * <p>Triggered when an administrator attempts a restricted operation (e.g.,
     * self-deactivation,
     ...
     *
     * <p>Triggered when an operation would violate configured administrator limits
     * (e.g., maximum
     ...
     *
     * <p>Triggered when an administrator attempts a restricted tenant operation
     * (e.g., deactivating
     ...
     *
     * <p>Triggered when an operation targets a resource belonging to an inactive
     * tenant. This
     ...
     *
     * <p>Triggered when Spring Security's method-level security (@PreAuthorize)
     * denies access due to
