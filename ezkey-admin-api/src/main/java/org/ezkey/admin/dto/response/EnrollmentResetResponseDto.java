 ...
 * <p>
 * Contains the new enrollment credentials that must be used to bind a
 * replacement device after the enrollment has been reset.
 * </p>
 * <p>
 * <b>Security:</b> The old device is now unbound and cannot be used for
 * authentication. The administrator must bind a new device using these
 * credentials.
 * </p>
 *
 * <p>
...
public class EnrollmentResetResponseDto {
     ...
     */
    public EnrollmentResetResponseDto(Integer enrollmentId, String enrollmentProofToken, 
                                      Integer enrollmentChallenge, Integer integrationId) {
        this.success = true;
        this.enrollmentId = enrollmentId;
        this.enrollmentProofToken = enrollmentProofToken;
        this.enrollmentChallenge = enrollmentChallenge;
        this.integrationId = integrationId;
        this.message = "Enrollment reset successfully. Old device unbound. Use these credentials to bind new device.";
    }
    ...
    public String toString() {
        return "EnrollmentResetResponseDto{" +
                ...
                ", enrollmentProofToken='" + (enrollmentProofToken != null ? "[PROTECTED]" : "null") + '\'' +
                ", enrollmentChallenge=" + (enrollmentChallenge != null ? "[PROTECTED]" : "null") +
