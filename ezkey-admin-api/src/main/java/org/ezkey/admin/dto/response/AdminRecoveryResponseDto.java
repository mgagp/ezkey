 ...
 * <p>
 * Contains a temporary recovery token that grants limited access (30 minutes)
 * for re-binding enrollment to a new device. The recovery token can only be
 * used for enrollment binding operations.
 * </p>
 *
 * <p>
...
public class AdminRecoveryResponseDto {
     ...
     * <p>
     * This token is valid for 30 minutes and can only be used for
     * enrollment binding operations. It cannot access other admin endpoints.
     * </p>
     */
     ...
     * <p>
     * Informs the administrator how many codes they have left.
     * When this reaches 0, they should generate new codes.
     * </p>
     */
     ...
     */
    public AdminRecoveryResponseDto(String recoveryToken, LocalDateTime expiresAt, Integer codesRemaining) {
        this.success = true;
        this.recoveryToken = recoveryToken;
        this.expiresAt = expiresAt;
        this.codesRemaining = codesRemaining;
        this.message = "Recovery successful. Token valid for 30 minutes. Re-bind enrollment immediately.";
    }
    ...
    public String toString() {
        return "AdminRecoveryResponseDto{" +
                "success=" + success +
                ", recoveryToken='" + (recoveryToken != null ? "[PROTECTED]" : "null") + '\'' +
                ", expiresAt=" + expiresAt +
                ", message='" + message + '\'' +
