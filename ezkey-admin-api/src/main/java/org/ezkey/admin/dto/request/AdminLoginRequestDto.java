 ...
 * <p>
 * This DTO contains the credentials required for passwordless administrator authentication
 * using Ezkey's cryptographic authentication system. Passwords are not supported.
 * </p>
 *
 * <p>
...
public class AdminLoginRequestDto {
     ...
     * <p>
     * When true, the authentication attempt will include a 6-digit challenge code
     * that must be verified on the device during approval. This provides an
     * additional security layer for high-security scenarios.
     * </p>
     * <p>
     * If not specified, defaults to the admin's challenge_required setting.
     * </p>
     */
