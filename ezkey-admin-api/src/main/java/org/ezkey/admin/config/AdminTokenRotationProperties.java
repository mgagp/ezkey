 ...
 * <p>
 * This class defines externalized configuration for the token rotation
 * feature, which deactivates old tokens when an administrator logs in.
 * This ensures that only one active token exists per administrator at any time.
 * </p>
 *
 * <p>
 * <b>Configuration Properties:</b>
 * <ul>
 * <li><b>rotationOnLoginEnabled:</b> Enable or disable rotation on login</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Limits to one active token per administrator</li>
 * <li>Stolen tokens become invalid on next legitimate login</li>
...
public class AdminTokenRotationProperties {
     ...
     * <p>
     * When enabled, all existing active tokens for an administrator
     * are deactivated when they log in, ensuring only one active token
     * exists at any time.
     * </p>
     * <p>
     * Default is true.
