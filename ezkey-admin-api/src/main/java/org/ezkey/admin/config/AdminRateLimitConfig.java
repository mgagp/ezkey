 ...
 * <p>
 * This configuration class sets up the rate limiting filter and related beans
 * when rate limiting is enabled via configuration properties.
 * Uses Bucket4j library for efficient token bucket rate limiting implementation.
 * </p>
 *
 * <p>
 * <b>Conditional Activation:</b> Rate limiting is only activated when
 * ezkey.admin.rate-limit.enabled=true in configuration.
 * </p>
 *
 * <p>
 * <b>Security Note:</b> Rate limiting relies on client IP detection through HTTP headers.
 * In production environments behind proxies, ensure proper configuration of
 * X-Forwarded-For headers and trusted proxy settings.
 * </p>
 *
 * <p>
 * <b>Dependencies:</b> Requires AdminRateLimitProperties for configuration
 * and Bucket4j libraries for rate limiting implementation.
 * </p>
 *
 * <p>
 ...
 */
@Configuration
@ConditionalOnProperty(name = "ezkey.admin.rate-limit.enabled", havingValue = "true", matchIfMissing = false)
...
public class AdminRateLimitConfig {
     ...
     * <p>
     * This warning alerts administrators to potential security issues
     * about potential security issues with IP-based rate limiting.
     * </p>
     */
     ...
     * <p>
     * This filter intercepts HTTP requests and applies rate limiting
     * to the admin login endpoint based on configured limits.
     * </p>
     *
    ...
    public AdminRateLimitFilter adminRateLimitFilter(AdminRateLimitProperties properties) {
        ...
        logger.info("  - Login requests: {} per {} minutes",
