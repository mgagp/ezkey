 ...
 * of the Ezkey administration API. It includes project information, available servers,
 * and security configuration for JWT authentication.
 * </p>
 *
 * <p>
 ...
 * <li><b>Security:</b> Bearer JWT authentication scheme</li>
 * </ul>
 * </p>
 *
 * <p>
 * <b>Access URLs:</b>
 * <ul>
 * <li><b>Swagger UI:</b> http://localhost:9080/swagger-ui.html</li>
 * <li><b>OpenAPI JSON:</b> http://localhost:9080/api-docs</li>
 * <li><b>OpenAPI YAML:</b> http://localhost:9080/api-docs.yaml</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class OpenApiConfig {
     ...
     * <p>
     * Configures the Bearer JWT security scheme for the entire API.
     * This scheme is applied globally to all admin API endpoints.
     * </p>
     *
