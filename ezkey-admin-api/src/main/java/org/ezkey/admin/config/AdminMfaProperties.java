 ...
 * <p>
 * These properties control how the admin MFA infrastructure is initialized
 * and how MFA is enforced for administrator authentication. The bootstrap
 * process automatically creates Integration Zero and Enrollment Zero at
 * application startup.
 * </p>
 *
 * <p>
 ...
 * <b>MFA Modes:</b>
 * <ul>
 * <li><b>dev:</b> MFA is optional, administrators can choose to enable it</li>
 * <li><b>prod:</b> MFA is required for all administrators</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class AdminMfaProperties {
     ...
     * <p>
     * <b>dev:</b> MFA is optional, administrators can choose to enable it.
     * Suitable for development and testing environments.
     * </p>
     * <p>
     * <b>prod:</b> MFA is required for all administrators.
     ...
     * Bootstrap configuration for automatic MFA infrastructure creation.
     * <p>
     * Controls whether Integration Zero and Enrollment Zero are automatically
     * created at application startup, enabling the "Eat Your Own Dog Food"
     * approach where Ezkey uses its own MFA solution for admin authentication.
     * </p>
     */
    public static class BootstrapConfig {
         ...
         * <p>
         * When enabled, the application automatically creates Integration Zero
         * and optionally Enrollment Zero at startup if they don't exist.
         * </p>
         */
         ...
         * <p>
         * When enabled, the application automatically creates Enrollment Zero
         * for the admin user at startup. This is recommended for development
         * but should be carefully considered for production.
         * </p>
         * <p>
         * <b>Development:</b> true (convenient for testing)<br>
