 ...
 *
 * <p>
 * <b>Configuration Prefix:</b> ezkey.admin.rate-limit
 * </p>
 *
 * <p>
...
public class AdminRateLimitProperties {
    ...
    public static class LoginConfig {
         ...
         * Options: "client-ip" (default)
         * Default: "client-ip"
         */
        private String keyStrategy = "client-ip";

        /**
         * Number of consecutive failures before blocking the client IP.
        ...
        /**
         * Duration in minutes to block a client IP after too many failures.
         * Default: 30 minutes.
         */
