...
public class AdminProvisioningController {
     ...
     *
     * <p>
     * <b>QR Code Format:</b> {@code enrollmentId|enrollmentProofToken}
     *
     * @param id   the administrator ID
     * @param auth the authentication context
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Generate QR code for onboarding", description = "Returns a PNG QR code image containing enrollment credentials"
     ...
     * /**
     * Deactivates an administrator (passwordless-only global admin operation).
     *
     * <p>
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Cannot deactivate: self-deactivation attempted or would violate limits (RFC 9457 Problem Detail)"),
