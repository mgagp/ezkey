...
public class IntegrationController {
     ...
     */
    @Operation(summary = "Retrieve all integrations", 
     ...
     */
    @Operation(summary = "Retrieve integration by ID", 
    ...
    public ResponseEntity<IntegrationResponse> getById(
        @Parameter(description = "Unique integration ID", example = "1") 
    ...
    public ResponseEntity<IntegrationCreateResponse> create(
        ...
        @RequestBody IntegrationCreateRequestDto request){
    ...
    @Operation(summary = "Delete integration", 
               description = "Removes an integration from the system")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> delete(
        @Parameter(description = "Integration ID to delete", example = "1")
        @PathVariable("id") Integer id){
