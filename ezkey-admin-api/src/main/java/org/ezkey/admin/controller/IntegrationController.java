 ...
 * <p>
 * This controller provides REST endpoints for integration management
 * operations, using the JPA-based service and DTOs for clean API responses. It
 * follows RESTful conventions and provides proper HTTP status codes and error
 * handling.
 * </p>
 *
 * <p>
 ...
 * <li><b>GET /api/v1/integrations/{id}/i18n</b> - Get integration i18n
 * data</li>
 * </ul>
 * </p>
 *
...
public class IntegrationController {
	 ...
	 * </p>
	 *
	 * @return ResponseEntity containing a list of IntegrationResponse objects with
	 *         HTTP 200 status
	 */
	@GetMapping
	 ...
	 * <p>
	 * Accepts a IntegrationCreateRequest and creates a new Integration. The service
	 * layer handles all business logic including default values, relationship
	 * management, and validation.
	 * </p>
	 *
	 * @param request the request containing integration data to create
	 * @return ResponseEntity containing the created IntegrationResponse with HTTP
	 *         201 status and Location header
	 */
	@PostMapping
	public ResponseEntity<IntegrationResponse> create(@RequestBody IntegrationCreateRequest request) {
		EzkeyIntegration savedIntegration = service.createIntegration(request);
	 ...
	 * <p>
	 * Updates the integration with the provided data and returns the updated
	 * entity.
	 * </p>
	 *
	 ...
	 */
	@PutMapping("/{id}")
	public ResponseEntity<IntegrationResponse> update(@PathVariable Integer id,
			@RequestBody IntegrationCreateRequest request) {
		...
		// Note: active status is not included in the request DTO, so we keep the
		// existing value
