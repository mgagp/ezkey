...
public class EnrollmentController {
   ...
   * @param integrationRepository  the integration repository for tenant
   *                               resolution in audit logs
   */
   ...
   *
   * <p>
   * Loads the integration by ID and traverses to its tenant to extract the tenant
   * ID. Returns
   * {@code null} if the integration or tenant cannot be resolved, which is safe
   * for audit logging
