 ...
 * 
 * <p>This service uses the ZXing (Zebra Crossing) library to generate QR codes
 * as PNG images. QR codes contain enrollment credentials in a simple format
 * that can be scanned by the mobile application.
 * 
 * <p><b>QR Code Format:</b> {@code enrollmentId|enrollmentProofToken}
 * 
 * <p><b>Example:</b> {@code 4|abc123def456...}
 * 
