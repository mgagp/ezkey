...
public final class AdminAuditConstants {
  ...
  /** Audit action for successful consumption of an activation code. */
  public static final String ACTIVATION_CODE_USED = "activation_code_used";

  /** Audit action for failed activation-code validation or activation attempt. */
  public static final String ACTIVATION_CODE_FAILED = "activation_code_failed";
