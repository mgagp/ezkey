...
public class AuthAttemptDto {
   ...
   */
  @Schema(
      description = "Timestamp when the authentication attempt was created",
   ...
   */
  @Schema(
      description = "Timestamp when the authentication attempt expires",
      example = "2025-01-27T10:35:00")
