 ...
 * <p>
 * This DTO represents the response from the authentication wait endpoint that
 * provides the final authentication status after polling for completion. It includes
 * both the raw authentication attempt data and a calculated status field for easy
 * consumption by integrating applications.
 * </p>
 *
 * <p>
 * <b>Usage Context:</b> Returned by the wait endpoint to provide applications with
 * the final authentication result after the device has responded or timeout has been
 * reached. The calculated status field simplifies integration logic.
 * </p>
 *
 * <p>
 * <b>Status Calculation Rules (from ENDPOINT.md):</b>
 * <ol>
 * <li><b>PENDING:</b> authAttemptRead is null or false</li>
 * <li><b>READ:</b> authAttemptRead is true and authAttemptResponded is null or false</li>
 * <li><b>INVALID:</b> authAttemptValid is null or false</li>
 * <li><b>REJECTED:</b> authAttemptAccepted is null or false</li>
 * <li><b>ACCEPTED:</b> authAttemptAccepted is true</li>
 * </ol>
 * </p>
 *
 * <p>
...
public class AuthAttemptWaitResponseDto {
     ...
     * </p>
     */
    @Schema(description = "Calculated authentication status", 
            example = "ACCEPTED",
     ...
     */
    @Schema(description = "Whether authentication process is complete", 
            example = "true")
     ...
     */
    @Schema(description = "Whether wait ended due to timeout", 
            example = "false")
     ...
     */
    @Schema(description = "Actual duration waited in seconds", 
            example = "15")
     ...
     */
    @Schema(description = "Timestamp when wait operation completed",example = "2025-01-27T10:30:15+01:00")
     ...
     */
    public AuthAttemptWaitResponseDto(AuthAttemptDto authAttempt, String status, Boolean completed, 
