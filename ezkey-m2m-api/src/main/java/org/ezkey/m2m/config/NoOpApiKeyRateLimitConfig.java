...
import org.ezkey.m2m.security.NoOpRateLimitServiceWrapper;
...
public class NoOpApiKeyRateLimitConfig {
  ...
  public ApiKeyRateLimitProperties apiKeyRateLimitProperties() {
    logger.warn("M2M API Key Rate Limiting is DISABLED — using no-op implementation");
  ...
  public RateLimitService rateLimitService(
    ...
    logger.warn("Creating NoOpRateLimitServiceWrapper for M2M API");
