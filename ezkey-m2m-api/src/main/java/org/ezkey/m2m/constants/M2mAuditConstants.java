 ...
 *
 * Constants: M2mAuditConstants
 * Description: Audit action constants for M2M API operations.
 */

package org.ezkey.m2m.constants;

/**
 * Audit action constants for M2M (machine-to-machine) API operations.
 *
 * <p>Centralises all audit action strings used throughout the M2M API controller, eliminating magic
 * strings and providing a single point of change for audit action names.
 *
 ...
 * @since 2025
 */
public final class M2mAuditConstants {

  private M2mAuditConstants() {
