 ...
 *
 * <p>This is a direct copy of the admin-api filter scoped to the M2M module package. Extraction to
 * a shared module ({@code ezkey-security-common}) is deferred to a future phase.
 *
