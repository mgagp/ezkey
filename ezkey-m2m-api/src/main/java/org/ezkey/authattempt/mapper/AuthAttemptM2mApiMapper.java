 ...
 *
 * Mapper: AuthAttemptM2mApiMapper
 * Description: MapStruct mapper for converting between AuthAttempt entities and DTOs in M2M API.
 */
...
/**
 * MapStruct mapper interface for converting between AuthAttempt entities and DTOs in the M2M API.
 *
 * <p>This mapper provides the conversions required by the M2M (machine-to-machine) API controllers.
 * It intentionally omits admin-specific mappings (e.g. create-request DTO → domain, since the M2M
 * controller resolves the enrollment separately before constructing the domain object directly).
 *
...
public interface AuthAttemptM2mApiMapper {
