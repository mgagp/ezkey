...
/**
 * CLI tests for basic commands including help, version, and subcommand discovery.
 *
...
public class CliCommandsTest extends AbstractSecurityTest {
  ...
  /** Tests that the version command executes successfully and outputs version information. */
  @Test
  ...
  void testAdminUrlOption() {
    CliExecutionResult result =
        cliTestHelper.execute("--admin-url=http://test:9080", "admin", "--help");
