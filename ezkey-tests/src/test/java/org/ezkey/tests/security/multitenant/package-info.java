 ...
 *
 * <p>
 * This package contains critical security tests (P0) that validate tenant
 * isolation boundaries.
 * These tests ensure that TenantAdmin users cannot access resources belonging
 * to other tenants.
 *
 * <h2>Multi-Tenant Philosophy</h2>
 *
 * <p>
 * Ezkey implements a pragmatic multi-tenant architecture with the "No
 * Impersonation" principle:
 *
 * <ul>
 * <li><b>GlobalAdmin</b>: VIEWS all resources (cross-tenant) but CREATES only
 * in System Tenant
 * <li><b>TenantAdmin</b>: VIEWS and CREATES only within their own tenant
 * <li><b>No Cross-Tenant Creation</b>: Administrators cannot create resources
 * for other tenants
 * </ul>
 *
 * <p>
 * <b>Key Documentation:</b>
 *
 * <ul>
 * <li>{@code ../../../../reference/MULTI_TENANT.md} - Complete philosophy and
 * matrices
 * <li>{@code ../../../../AGENTS.md} - Quick reference for AI agents
 * <li>{@code docs/testing/MULTI_TENANT_TEST_PLAN.md} - Detailed test plan
 * <li>{@code docs/testing/TENANT_PERMISSIONS_TEST_STRATEGY.md} - Permission
 * matrices
 * </ul>
 *
 * <h2>Test Classes</h2>
 *
 * <ul>
 * <li>{@link org.ezkey.tests.security.multitenant.TenantCrossIsolationSecurityTest}
 * - P0
 * cross-tenant isolation tests
 * <li>{@link org.ezkey.tests.security.multitenant.TenantBoundaryPermissionsSecurityTest}
 * - P1
 ...
 *
 * <p>
 * Tests use <b>unique data creation</b> for idempotence:
 *
 * <pre>{@code
 ...
 *
 * <p>
 * No cleanup required - tests can run multiple times without conflicts.
 *
 * <h2>Common Pitfalls</h2>
 *
 * <ul>
 * <li>⚠️ <b>Using GlobalAdmin token for tenant resources</b>: Always use
 * TenantAdmin tokens to
 * create tenant-specific resources in isolation tests
 * <li>⚠️ <b>Expecting 403 on list endpoints</b>: TenantAdmin listings return
 * filtered results,
 * not 403
 * <li>⚠️ <b>Missing tenantId in DTOs</b>: Some responses omit tenantId - use
 * indirect assertions
