# Java doctor-curated configuration

Pinned analyzer inputs for `./scripts/java-doctor-curated.sh` (keyword `java-doctor-curated`).

| File | Role |
|------|------|
| `pmd-ruleset.xml` | Narrow PMD design/maintainability rules (not the full catalogue) |
