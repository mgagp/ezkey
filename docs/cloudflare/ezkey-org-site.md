...
- **Source:** [sites/ezkey-org/](../../sites/ezkey-org/) — includes `sitemap.xml`, `robots.txt`, and **Monthly digests** RSS (`monthly-digest.rss`, `fr/monthly-digest.rss`); compact landings: `index.html` (EN, `/`), `fr/index.html` (FR, **`/fr/`**); content hubs: `monthly-digest.html` / `fr/monthly-digest.html`, `articles.html` / `fr/articles.html`, `source-and-evaluation.html` / `fr/source-and-evaluation.html`, `trust.html` / `fr/trust.html`, `changelog.html` / `fr/changelog.html`; API portal pages: `api-docs.html`, `admin-api-reference.html`, `auth-api-reference.html`, `integration-api-reference.html`; logo asset `logo.svg` referenced from pages.
...
1. **Edit content** — Update the relevant static HTML under [sites/ezkey-org/](../../sites/ezkey-org/) (landing, [`monthly-digest.html`](../../sites/ezkey-org/monthly-digest.html) / [`fr/monthly-digest.html`](../../sites/ezkey-org/fr/monthly-digest.html), [`articles.html`](../../sites/ezkey-org/articles.html) index, article pages, etc.) and commit. See [sites/ezkey-org/AGENTS.md](../../sites/ezkey-org/AGENTS.md) for IA and bilingual rules.
