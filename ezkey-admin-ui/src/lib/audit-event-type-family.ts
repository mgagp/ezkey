...
export const AUDIT_EVENT_TYPE_GROUPS: readonly AuditEventTypeGroup[] = [
  ...
  {
    family: 'AUDIT_CHAIN',
    memberKeys: ['AUDIT_CHAIN_ARCHIVE_SEALED', 'AUDIT_CHAIN_GAP_DECLARED', 'AUDIT_INTEGRITY_RUPTURE_CONCILIATED', 'AUDIT_CHAIN_GAP_PENDING', 'NIGHTLY_INTEGRITY_VALIDATION_COMPLETED', 'INTEGRITY_ASYNC_JOB_STARTED', 'INTEGRITY_ASYNC_JOB_COMPLETED', 'INTEGRITY_ASYNC_JOB_ABANDONED'],
  },
] as const;
