...
function renderMarkdownReport({
  ...
  lines.push(
    ...
    '- Brief the maintainer first (continuous learning), then implement on a hygiene branch + PR.',
    '- Carry the briefing into the PR description — that is the durable continuous-improvement trace.',
