 ...
 * to initiate the device enrollment process. It contains the basic enrollment
 * configuration including integration association, enrollment naming, and
 * authentication policy settings for the new enrollment.
 * </p>
 *
 * <p>
 * <b>Usage Context:</b> Used by the EnrollmentService when creating new
 * device enrollments through the enrollment API. The service layer transforms
 * API DTOs into this domain object for business logic processing and
 * enrollment entity creation.
 * </p>
 *
 * <p>
 * <b>Enrollment Flow:</b> This request initiates the enrollment process by
 * providing the foundational configuration for a new enrollment. After
 * processing this request, the system generates enrollment challenges and
 * proof tokens that guide the device through the enrollment verification
 * and binding process.
 * </p>
 *
 * <p>
 * <b>Integration Binding:</b> Links the enrollment to a specific integration
 * context, ensuring that authentication attempts are properly scoped and
 * validated against the correct application or service integration.
 * </p>
 *
 * <p>
 * <b>Authentication Policy:</b> Allows configuration of challenge requirements
 * for future authentication attempts, enabling flexible security policies
 * based on risk assessment and integration requirements.
 * </p>
 *
 * <p>
...
public class EnrollmentCreateRequest {
     ...
     * <p>
     * Must reference an existing and active integration. This links the
     * enrollment to a specific application or service context, ensuring
     * that authentication attempts are properly scoped and validated
     * against the correct integration's security policies and configuration.
     * </p>
     */
     ...
     * <p>
     * Provides a descriptive label for the enrollment that can be displayed
     * in user interfaces and device management screens. This name helps
     * users identify and manage multiple enrollments across different
     ...
     * additional challenge responses beyond the standard cryptographic proof.
     * This may include biometric verification, PIN entry, or other multi-factor
     * authentication requirements as determined by the integration's security
