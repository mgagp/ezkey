 ...
 * <p>
 * This domain object represents the complete enrollment information returned by
 * the service layer for enrollment queries and management operations. It provides
 * a comprehensive view of enrollment state, configuration, cryptographic keys,
 * and metadata necessary for enrollment management and authentication operations.
 * </p>
 *
 * <p>
 * <b>Usage Context:</b> Used by the EnrollmentService to return detailed
 * enrollment information for administrative operations, enrollment status
 * queries, and integration with other system components. This response
 * provides a clean separation between domain entities and API responses.
 * </p>
 *
 * <p>
 * <b>Enrollment Lifecycle:</b> Contains all enrollment state flags including
 * read status, validity, and activation state that track the enrollment
 * through its complete lifecycle from creation to active authentication
 * operations or deactivation.
 * </p>
 *
 * <p>
 * <b>Cryptographic Identity:</b> Includes both integration and device public
 * keys that establish the cryptographic relationship between the integration
 * system and enrolled device. These keys enable secure authentication
 * operations and signature verification.
 * </p>
 *
 * <p>
 * <b>Challenge Configuration:</b> Provides enrollment challenge data and
 * authentication policy settings that control how future authentication
 * attempts will be processed for this specific enrollment.
 * </p>
 *
 * <p>
 * <b>Administrative Data:</b> Includes creation timestamps and identification
 * information necessary for enrollment management, audit trails, and
...
public class EnrollmentResponse {
     ...
     * <p>
     * Auto-generated primary key from the database that uniquely identifies
     * this enrollment within the system. Used for all enrollment operations
     * and references from other system components.
     * </p>
     */
     ...
     * <p>
     * Foreign key reference to the integration that created this enrollment.
     * Links the enrollment to its parent integration context for proper
     * scoping and security validation during authentication operations.
     * </p>
     */
     ...
     * <p>
     * Descriptive label for the enrollment used for display purposes in
     * user interfaces and administrative screens. Helps users identify
     * and manage multiple enrollments across different integrations
     * and devices.
     * </p>
     */
     ...
     * <p>
     * Controls whether the enrollment can be used for authentication
     * operations. Inactive enrollments are disabled but preserved for
     * audit purposes and can be reactivated if needed.
     * </p>
     */
     ...
     * <p>
     * Numeric challenge token used during the enrollment verification
     * process. This value is validated during device verification to
     * ensure legitimate enrollment completion and prevent unauthorized
     ...
     * to establish secure binding between device and enrollment. This
     * token must be signed by the device to complete enrollment and
     * prove cryptographic capability.
     * </p>
     */
     ...
     * <p>
     * Configuration setting that determines whether authentication attempts
     * using this enrollment will require additional challenge responses
     * beyond standard cryptographic proof. Enables flexible security
     * policies based on risk assessment and integration requirements.
     * </p>
     */
     ...
     * <p>
     * Cryptographic public key of the integration used for verifying
     * signatures and validating messages from the integration system.
     * Enables the device to cryptographically verify the authenticity
     * of authentication challenges and integration communications.
     * </p>
     */
     ...
     * <p>
     * Cryptographic public key of the device established during enrollment
     * verification. Used by the system to verify signatures from the device
     * during authentication attempts and ensure only the legitimate enrolled
     * device can respond to authentication challenges.
     * </p>
     */
     ...
     * <p>
     * Records the exact time when the enrollment was initially created in
     * the system. Used for audit trails, lifecycle management, and sorting
     ...
     *
     * @param authAttemptChallengeRequired true if authentication attempts should require additional challenges
     */
