 ...
 * unified public API. It implements the enrollment lifecycle where devices
 * bind to integrations and complete enrollment verification.
 * </p>
 *
 * <p>
 * <b>Architecture:</b>
 ...
 * <ul>
 * <li><b>EnrollmentBindService:</b> Handles enrollment binding operations</li>
 * <li><b>EnrollmentVerifyService:</b> Processes enrollment verification</li>
 * <li><b>EnrollmentTxHelper:</b> Manages transactional operations and cleanup</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li><b>Creation Flow:</b> Creates enrollments via Admin API for web applications</li>
 * <li><b>Binding Flow:</b> Processes device binding via Auth API for mobile devices</li>
 * <li><b>Verification Flow:</b> Completes enrollment verification with cryptographic proof</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <li><b>Device Key Uniqueness:</b> Ensures device public keys are used only once</li>
 * <li><b>Challenge-Based Security:</b> Implements numeric challenges for additional verification</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li><b>EnrollmentRepository:</b> Data persistence layer for enrollments</li>
 * <li><b>SignatureService:</b> Cryptographic operations for signature validation</li>
 * <li><b>EnrollmentBindService:</b> Specialized service for enrollment binding operations</li>
 * <li><b>EnrollmentVerifyService:</b> Specialized service for enrollment verification operations</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li><b>Read-Once Guarantee:</b> Enrollments can only be bound once to prevent replay attacks</li>
 * <li><b>Efficient Locking:</b> Optimized database queries for enrollment state management</li>
...
public class EnrollmentService {
     ...
     * <p>
     * This method delegates to the specialized EnrollmentBindService to handle
     * the complex logic of enrollment binding while maintaining the same public
     ...
     * the complex logic of enrollment verification while maintaining the same public
     * API for backward compatibility.
     * </p>
     *
