...
public class EncryptionService {
   ...
   *
   * <p>All encrypted values start with this prefix, making it easy to detect encrypted data vs
   * plaintext (e.g., PEM keys).
   */
   ...
   *
   * <p>If the value starts with "ENC:" prefix, it will be decrypted. Otherwise, it is assumed to be
   * plaintext (backward compatibility with existing data).
   *
  ...
  public String decrypt(String encryptedValue) {
    ...
    try {
      ...
      logger.warn(
          "Decryption failed, assuming plaintext for backward compatibility: {}", e.getMessage());
