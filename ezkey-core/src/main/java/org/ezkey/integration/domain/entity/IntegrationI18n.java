 ...
 *
 * <p>This entity stores localized information (name and description) for integrations in different
 * languages. Each integration can have multiple i18n entries for different language codes.
 *
 * <p><b>Project:</b> Ezkey - Open Source MFA/Passkey Alternative
 *
 * <p><b>License:</b> MIT
 *
 * <p><b>Table:</b> ezkey_integration_i18n
 *
...
public class IntegrationI18n {
  ...
  /** Unique identifier for the i18n entry. Auto-generated using database identity. */
  @Id
  ...
  /**
   * Reference to the parent integration. Many-to-one relationship with lazy loading for
   * performance.
   */
