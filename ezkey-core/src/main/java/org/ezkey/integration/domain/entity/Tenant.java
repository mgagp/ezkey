 ...
 * Each tenant has its own isolated data and can have multiple administrators
 * and integrations. Tenants are created by global administrators and provide
 * the foundation for multi-tenant data isolation.
 * </p>
 *
 * <p>
 * <b>Multi-Tenant Architecture:</b>
 * <ul>
 * <li><b>Data Isolation:</b> Each tenant has completely isolated data</li>
 * <li><b>Administrator Hierarchy:</b> Tenants can have tenant admins and integration admins</li>
 * <li><b>Integration Management:</b> Each tenant manages its own integrations</li>
 * <li><b>Security:</b> Tenant data is only accessible by authorized administrators</li>
 * </ul>
 * </p>
 *
 * <p>
 * <b>Relationships:</b>
 * <ul>
 * <li><b>Created By:</b> Reference to the global administrator who created this tenant</li>
 * <li><b>Administrators:</b> List of administrators belonging to this tenant</li>
 * <li><b>Integrations:</b> List of integrations belonging to this tenant</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class Tenant {
     ...
     * <p>
     * This field is required and must be unique across all tenants.
     ...
     * <p>
     * This field provides additional context about the tenant,
     * such as company description or purpose.
     * </p>
     */
     ...
     * <p>
     * Inactive tenants cannot be used for new operations but
     * existing data is preserved for audit purposes.
     * </p>
     */
     ...
     * <p>
     * This relationship includes both tenant administrators and
     * integration administrators for this tenant.
     * </p>
     */
     ...
     * <p>
     * This relationship includes all integrations created
     * within this tenant's scope.
     * </p>
     */
    @OneToMany(mappedBy = "tenant")
     ...
     * <p>
     * This constructor creates a new tenant with the provided name
     * and description. The created timestamp is set to the current time
     * and the tenant is marked as active by default.
     * </p>
     *
