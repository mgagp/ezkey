 ...
 *
 * <p>
 * A tenant represents an organization or company that uses the Ezkey system.
 * Each tenant has its
 * own isolated data and can have multiple administrators and integrations.
 * Tenants are created by
 * global administrators and provide the foundation for multi-tenant data
 * isolation.
 *
 * <p>
 ...
 * <li><b>Administrator Hierarchy:</b> Tenants can have tenant admins and
 * integration admins
 * <li><b>Integration Management:</b> Each tenant manages its own integrations
 * <li><b>Security:</b> Tenant data is only accessible by authorized
 * administrators
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Created By:</b> Reference to the global administrator who created this
 * tenant
...
public class Tenant {
     ...
     *
     * <p>
     * This field is required and must be unique across all tenants. Used for
     * identification and
     * display purposes.
     */
     ...
     *
     * <p>
     * This field provides additional context about the tenant, such as company
     * description or
     * purpose.
     */
     ...
     *
     * <p>
     * This field tracks the administrator responsible for creating this tenant in
     * the system.
     */
     ...
     *
     * <p>
     * This field is automatically set to the current timestamp when the tenant is
     * created.
     */
     ...
     *
     * <p>
     * Inactive tenants cannot be used for new operations but existing data is
     * preserved for audit
     * purposes.
     */
     ...
     *
     * <p>
     * System tenant hosts global administrators and represents the organization
     * hosting this Ezkey
     * instance. Only one tenant should have this flag set to true. Application
     * tenants (created by
     * global administrators) should have this flag set to false.
     *
     * <p>
     * This flag provides a robust way to distinguish system tenant from application
     * tenants
     ...
     *
     * <p>
     * Distinct from {@code tenantName} which is a short technical identifier.
     * This field holds the full legal entity name (e.g. "Acme Corporation Inc.").
     */
     ...
     *
     * <p>
     * Used for email correlation, future SSO integration, and
     ...
     *
     * <p>
     * Determines data residency requirements and applicable
     * compliance regulations (e.g. GDPR, SOC 2).
     */
     ...
     *
     * <p>
     * Used for audit report timestamps, notification scheduling,
     * and maintenance window calculations.
     */
     ...
     *
     * <p>
     * SOC 2 CC2.1 requires an identifiable point of contact for
     * security communications and incident response.
     */
     ...
     *
     * <p>
     * Used for incident notifications, certificate expiration
     ...
     *
     * <p>
     * SOC 2 CC7.2 requires change tracking. This field is set
     * automatically by the service layer on every update.
     */
     ...
     *
     * <p>
     * Provides accountability for changes (SOC 2 CC7.2).
     */
    @ManyToOne(fetch = jakarta.persistence.FetchType.LAZY)
     ...
     *
     * <p>
     * Records the exact moment of deactivation for audit trail
     * (SOC 2 CC6.3 — access removal tracking).
     */
     ...
     *
     * <p>
     * Provides accountability for deactivation (SOC 2 CC6.3).
     */
    @ManyToOne(fetch = jakarta.persistence.FetchType.LAZY)
     ...
     *
     * <p>
     * This relationship includes both tenant administrators and integration
     * administrators for
     * this tenant.
     */
     ...
     *
     * <p>
     * This relationship includes all integrations created within this tenant's
     * scope.
     */
    @OneToMany(mappedBy = "tenant")
     ...
     *
     * <p>
     * This constructor is required by JPA and should not be used for business
     * logic. Use the
     ...
     *
     * <p>
     * This constructor creates a new tenant with the provided name and description.
     * The created
     * timestamp is set to the current time and the tenant is marked as active by
     * default.
     *
     ...
     *
     * <p>
     * This constructor creates a tenant with organizational identity
     * fields in addition to the basic name and description.
     *
     * @param tenantName          the unique name of the tenant
