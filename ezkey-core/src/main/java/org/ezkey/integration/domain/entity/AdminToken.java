 ...
 * <p>
 * This entity stores bearer tokens used for API authentication by administrators.
 * Each token is associated with a specific administrator and contains metadata
 * about the authentication session including IP address, user agent, and expiration.
 * </p>
 *
 * <p>
 * <b>Token Security:</b>
 * <ul>
 * <li><b>Unique Tokens:</b> Each token is unique and cannot be duplicated</li>
 * <li><b>Expiration:</b> Tokens have configurable expiration times</li>
 * <li><b>Audit Trail:</b> All token usage is tracked for security</li>
 * <li><b>Revocation:</b> Tokens can be invalidated for security purposes</li>
 * </ul>
 * </p>
 *
 * <p>
 * <b>Token Metadata:</b>
 * <ul>
 * <li><b>IP Address:</b> Tracks the IP address from which the token was issued</li>
 * <li><b>User Agent:</b> Records the user agent string for audit purposes</li>
 * <li><b>Last Used:</b> Tracks when the token was last used for authentication</li>
 * <li><b>Expiration:</b> Configurable expiration time for token validity</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class AdminToken {
     ...
     * <p>
     * This field contains the actual token string that is sent in the
     ...
     * <p>
     * This field establishes the relationship between the token
     * and the administrator who can use it for authentication.
     * </p>
     */
     ...
     * <p>
     * This field stores the administrator type for quick access
     * without needing to join with the admin table.
     * </p>
     */
     ...
     * <p>
     * This field is null for global administrators and contains
     * the tenant reference for tenant and integration administrators.
     * </p>
     */
    @ManyToOne(fetch = FetchType.LAZY)
     ...
     * <p>
     * This field determines when the token becomes invalid
     ...
     * <p>
     * This field is updated each time the token is used
     * for authentication to track usage patterns.
     * </p>
     */
     ...
     * <p>
     * This field stores the IP address for security audit
     ...
     * <p>
     * This field stores the user agent for security audit
     * and can be used to detect suspicious activity.
     * </p>
     */
     ...
     * <p>
     * This constructor creates a new admin token with the provided
     * bearer token, administrator, and expiration time.
     * </p>
     *
     ...
     */
    public AdminToken(String bearerToken, EzkeyAdmin admin, String adminType, OffsetDateTime expiresAt) {
