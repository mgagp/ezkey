 ...
 *
 * <p>This repository provides standard CRUD operations for Integration I18n entities and can be
 * extended with custom query methods for language-specific operations.
 *
 * <p><b>Project:</b> Ezkey - Open Source MFA/Passkey Alternative
 *
 * <p><b>License:</b> MIT
 *
 * <p><b>Entity:</b> EzkeyIntegrationI18n
 *
...
public interface IntegrationI18nRepository extends JpaRepository<IntegrationI18n, Integer> {
  ...
  // Optional<EzkeyIntegrationI18n> findByIntegrationIdAndLanguage(Integer integrationId, String
  // language);
}
