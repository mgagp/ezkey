 ...
 * license information.
 *
 * Class: GlobalExceptionHandler Description: Centralized exception handling for the Ezkey REST API.
 */
...
/**
 * Global exception handler for the Ezkey REST API.
 * <p>
 * This class provides centralized exception handling for all controllers in the Ezkey API, ensuring consistent error
 ...
 * <li><b>Generic Exception:</b> Returns HTTP 500 with a generic error message for security</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * </p>
 * <p>
 * <b>Usage:</b> Centralized exception handling for all Ezkey API controllers
 * </p>
 *
...
public class GlobalExceptionHandler{
     ...
     * requested resources cannot be found. It creates a standardized error response with the exception message and
     * request path information for debugging purposes.
     * </p>
     *
     * <p>
     * <b>HTTP Response:</b>
     ...
     * a generic error message to avoid exposing sensitive information while still providing useful debugging
     * information through the request path.
     * </p>
     *
     * <p>
     * <b>Security Note:</b> This handler intentionally uses a generic error message to prevent information leakage that
