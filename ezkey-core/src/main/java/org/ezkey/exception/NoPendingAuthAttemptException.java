 ...
 * <p>
 * This exception represents a normal state in MFA systems where devices poll for
 * pending authentication attempts. The absence of a pending attempt is not an error
 * condition but a normal operational state that should be handled gracefully.
 * </p>
 *
 * <p>
 * <b>Usage Context:</b> Used by the AuthAttemptService when a device polls for
 * pending authentication attempts but none are found. This allows the controller
 * to return appropriate HTTP status codes (204 No Content) instead of error codes.
 * </p>
 *
 * <p>
 * <b>MFA Context:</b> In pull-based MFA systems, devices regularly poll for
 * pending authentication requests. The absence of pending requests is expected
 * and should not be treated as an error condition.
 * </p>
 *
 * <p>
