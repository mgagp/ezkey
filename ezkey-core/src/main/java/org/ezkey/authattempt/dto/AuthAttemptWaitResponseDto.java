 ...
 *
 * <p>Provides a comprehensive view of the wait operation result, including the current
 ...
 *   <li><b>INVALID</b> – authentication failed validation (wrong signature, challenge, etc.)
 *   <li><b>REJECTED</b> – user explicitly rejected the authentication request
 *   <li><b>ACCEPTED</b> – user accepted; proof token is available in {@code authAttempt}
 * </ul>
 *
 ...
 * @param completed whether the device has responded (ACCEPTED, REJECTED, or INVALID)
 * @param timeoutReached whether the wait ended due to timeout before a response
 * @param waitDuration actual number of seconds waited before this response was returned
