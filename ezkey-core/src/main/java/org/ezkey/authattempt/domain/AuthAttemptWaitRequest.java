 ...
 * <p>
 * This domain object represents the request parameters for the authentication wait operation
 * that allows applications to poll for authentication completion. It provides configurable
 * timeout and polling interval parameters for flexible waiting behavior.
 * </p>
 *
 * <p>
 * <b>Usage Context:</b> Used by the service layer to handle authentication wait operations.
 * This domain object is mapped from the corresponding DTO and contains the business logic
 * parameters for polling configuration.
 * </p>
 *
 * <p>
 * <b>Parameters:</b>
 ...
 * <ul>
 * <li>timeout must be between 1 and 300 seconds</li>
 * <li>polling must be between 1 and 60 seconds</li>
 * <li>polling must be less than or equal to timeout</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class AuthAttemptWaitRequest {
     ...
     * Must be between 1 and 300 seconds. Controls how long the service will wait
     * before returning a timeout response.
     */
    private Integer timeout;

    /**
     * Interval between status checks during waiting in seconds.
     * Must be between 1 and 60 seconds, and less than or equal to timeout.
     * Controls how frequently the system checks for authentication completion.
     */
    private Integer polling;

    /**
     * Default constructor for AuthAttemptWaitRequest.
