...
CREATE TABLE ezkey_enrollment (
    ...
    enrollment_read BOOLEAN NOT NULL DEFAULT FALSE,
    enrollment_verified BOOLEAN NOT NULL DEFAULT FALSE,
    enrollment_valid BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE ezkey_auth_attempt (
    ...
    auth_attempt_read BOOLEAN NOT NULL DEFAULT FALSE,
    auth_attempt_responded BOOLEAN NOT NULL DEFAULT FALSE,
