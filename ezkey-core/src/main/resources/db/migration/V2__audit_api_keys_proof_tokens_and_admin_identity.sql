...
--              monitoring, forensic analysis, and operator-visible audit.
--
...
--          security monitoring and durable operator-visible audit.
--
...
'Comprehensive audit logging for security monitoring, forensic analysis, and operator-visible audit. Tracks all critical operations across admin-api and auth-api with full context including IP addresses, user agents, and entity references.';
...
-- Ready for security monitoring and operator-visible audit tracking.
-- ============================================================================
-- ============================================================================
...
-- ============================================================================
-- Historical V13 (folded here): Add email column to ezkey_admin
-- ============================================================================
-- Description: Adds email column to ezkey_admin table for identifiable operator
--              identity (named person, not a generic account) and audit trail.
--
-- Product rules:
--   - Identifiable operator identity: email required for GLOBAL_ADMIN
--   - Operator-visible audit trail must identify individuals, not generic accounts
--
-- Author: Ezkey contributors
-- Date: 2025-01-XX
-- ============================================================================
...
-- Email is required for GLOBAL_ADMIN type (identifiable operator identity)
...
'Email address for the administrator. Required for GLOBAL_ADMIN type for identifiable operator identity. '
...
-- ============================================================================
-- Historical V14 (folded here): Add first name and last name to ezkey_admin
-- ============================================================================
-- Description: Adds first_name and last_name columns to ezkey_admin for
--              identifiable operator identity (named person, not a generic account).
--
-- Product rules:
--   - Identifiable operator identity: first and last name required for GLOBAL_ADMIN
--   - Operator-visible audit trail must identify individuals, not generic accounts
--
-- Author: Ezkey contributors
-- Date: 2025-01-XX
...
'First name of the administrator. Required for GLOBAL_ADMIN type for identifiable operator identity. '
...
'Last name of the administrator. Required for GLOBAL_ADMIN type for identifiable operator identity. '
'Used for audit trail and accountability. Must be provided for initial global admin.';
