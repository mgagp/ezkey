 ...
 *
 * <p>This configuration sets up the WebClient for communicating with the Ezkey Admin API
 * (ezkey-admin-api) running on port 9080. It provides the foundation for all integration management
 * operations in the ACME demo application.
 *
 * <p><b>API Integration:</b> Connects to ezkey-admin-api to manage:
 *
 * <ul>
 *   <li>Integration creation and management
 *   <li>Enrollment administration
 *   <li>Authentication attempt monitoring
 * </ul>
 *
 * <p><b>Configuration Properties:</b>
 *
 * <ul>
 *   <li><code>ezkey.admin.api.url</code> - Base URL for Ezkey Admin API
 * </ul>
 *
...
public class EzkeyApiClientConfig {
   ...
   *
   * <p>The WebClient is pre-configured with the base URL and default headers for optimal
   * integration with the Ezkey Admin API. It handles all HTTP communication including JSON
