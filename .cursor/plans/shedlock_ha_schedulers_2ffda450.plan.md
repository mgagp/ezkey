...
- This approach is database-backed and fits Ezkey’s existing PostgreSQL + Flyway architecture.
- It prevents duplicates/races in HA while still allowing failover via `lockAtMostFor` expiry.