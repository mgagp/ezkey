...
Write-Host "  - Admin API:    http://localhost:9080/swagger-ui/index.html"
Write-Host "  - Auth API:     http://localhost:8080/swagger-ui/index.html"
Write-Host "  - Crypto API:   http://localhost:9090/swagger-ui/index.html"
Write-Host ""
