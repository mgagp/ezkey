...
| Installation refresh | `useRefreshInstallationMetadata` | Persisted enrollments | Refreshed nested installation objects | Uses signed enrolled instance-info opportunistically; no unsigned GET fallback. |
