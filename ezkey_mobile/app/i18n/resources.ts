  ...
  en: {
    translation: {
      ...
      home: {
        ...
        releaseBannerTitle: 'Ezkey Mobile 1.0',
        releaseBannerBody:
          'Enroll a trusted device and approve sign-ins. Tap to see what this release includes.',
        releaseBannerAction: 'Learn more',
        releaseBannerHint: 'Opens the current release notes',
  ...
  fr: {
    translation: {
      ...
      home: {
        ...
        releaseBannerTitle: 'Ezkey Mobile 1.0',
        releaseBannerBody:
          'Enrôlez un appareil de confiance et approuvez les connexions. Touchez pour voir le contenu de cette version.',
        releaseBannerAction: 'En savoir plus',
        releaseBannerHint: 'Ouvre les nouveautés de la version en cours',
