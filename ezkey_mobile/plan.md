...
- **Android builds**: Run Yarn CLI scripts (`yarn android:assemble:debug`, `yarn android:bundle:release`, etc.) from Git Bash; Android Studio Wi-Fi pairing instructions documented for Pixel 7 Pro mirroring workflows.
...
- Debug and release Android variants must compile via CLI scripts and Android Studio with Wi-Fi paired devices.
...
- [ ] CLI build scripts available; Android Studio Wi-Fi pairing + deployment guide published
