...
public class SimController {
    ...
    @Operation(
        ...
        description = "Generates a cryptographically secure proof token for use in authentication flows"
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Generates a new RSA key pair for use in device simulation. Default key size is 2048 bits."
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<RsaKeyPairResponseDto> generateKeyPair(
        ...
        var response = new RsaKeyPairResponseDto(
            keyPair.base64PrivateKey(), 
    ...
    @PostMapping("/sign")
    public ResponseEntity<SignDataResponseDto> signData(@Valid @RequestBody SignDataRequestDto request) {
    ...
    public ResponseEntity<ValidateSignatureResponseDto> validateSignature(@Valid @RequestBody ValidateSignatureRequestDto request) {
