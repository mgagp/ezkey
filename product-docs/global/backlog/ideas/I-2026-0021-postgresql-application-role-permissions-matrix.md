...
- Downstream (P2, **done** 2026-07-18): [`I-2026-07-18-audit-log-peripheral-insert-only-hmac-sequence`](I-2026-07-18-audit-log-peripheral-insert-only-hmac-sequence.md) / [`TB-2026-07-18`](../TB-2026-07-18-audit-log-insert-only-hmac-seal.md) — peripheral **INSERT-only** on `ezkey_audit_log` via sequence pre-allocation + single INSERT
