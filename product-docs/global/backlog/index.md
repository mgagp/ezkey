...
| `I-2026-0011` | Bootstrap clean-start: activation-code mode as default | `triaged` | `P1` | `admin-api`, `infra (clean-start)`, `bootstrap`, `docs` | `2026-05-08` |
| `I-2026-0012` | Hard-coded `Ezkey System` user sensitivity audit | `triaged` | `P2` | `admin-api`, `core`, `infra` | `2026-05-08` |
| `I-2026-0013` | Paginated admin screens: functional and operational pertinence review | `triaged` | `P2` | `admin-ui`, `admin-api` | `2026-05-08` |
