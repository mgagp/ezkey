...
### Step 6 — Orval 8.8.1 (2026-05-28)

- Orval: `8.8.1` (latest 8.8.x); G0–G4 pass; Playwright **5/5**
- App files changed: none — lockfile only
- Notes: 8.8.x line complete; next step **8.9.0**

### Step 7 — Orval 8.9.0 (2026-05-28)

- Orval: `8.9.0`; G0–G4 pass; 54 Vitest tests
- Playwright: **5/5 passed** (~12.6s)
- App files changed: none — lockfile only
...
### Step 12 — Orval 8.12.2 (2026-05-29)

- Orval: `8.12.2`; lockfile only; G0–G4 pass; Playwright **5/5**
- Notes: next **8.12.3**, then **8.13.0** (final)

### Step 13 — Orval 8.12.3 (2026-05-29)
