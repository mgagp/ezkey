...
- **Single walkable SHA / PR:** https://github.com/mgagp/ezkey/pull/598 — walk **PR head** (`git fetch && git rev-parse origin/cursor/integrity-cut2-phase-b-936e`); authoring snapshot `3daaedf9e9d077adf4b7013e90adb8dc08d9cf69`
