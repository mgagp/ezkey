...
- **Single walkable SHA / PR:** https://github.com/mgagp/ezkey/pull/598 — walk **PR head** (`git fetch && git rev-parse origin/cursor/integrity-cut2-phase-b-936e`); tip at authoring was `a151065d6ab7a4c5916f5370ff32eff56d2851be`
