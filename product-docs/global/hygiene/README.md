...
and weekly **Dependabot** triage.

These folders are **not** product vision, ADR, or backlog execution. They record per-campaign triage
(fix / suppress / skip, or Dependabot merge / hold / defer) so cold sessions can see *why* a
...
and a session closeout validation ladder. See root [`AGENTS.md`](../../AGENTS.md) for keywords.
