...
- [`V-2026-09-26-temporary-evaluator-console-access`](V-2026-09-26-temporary-evaluator-console-access.md) — current community/alpha friction reduction: temporary navigable console (~8h) after activation; [`V-2026-09-26-evaluator-bootstrap-admin-session`](V-2026-09-26-evaluator-bootstrap-admin-session.md) superseded (Path B BOOTSTRAP abandoned); honesty bounds of this note still apply
