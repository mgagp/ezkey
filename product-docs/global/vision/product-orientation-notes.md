...
- **Next step:** promote into `I-2026-0026` to define the environment matrix, compare open-source portal candidates, choose the hosting placement model, and identify the first bounded implementation slice.
