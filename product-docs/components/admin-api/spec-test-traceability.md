...
| --- | --- | --- | --- | --- |
| [`F-admin-api-core`](../../global/features-and-phases.md#f-admin-api-core) | [`../../../docs/ENDPOINT.md`](../../../docs/ENDPOINT.md), [`functional-flows.md#w-api-integration-create`](functional-flows.md#w-api-integration-create) | Integrations CRUD endpoints behave per contract; role scoping enforced. | `mvn test -pl 'ezkey-admin-api,!ezkey-tests'`, Bruno collections under [`../../../bruno/`](../../../bruno/). | `implemented` |
...
| [`F-encryption-key-rotation`](../../global/features-and-phases.md#f-encryption-key-rotation) | [`functional-flows.md#w-api-encryption-key-rotation`](functional-flows.md#w-api-encryption-key-rotation), [`../../../docs/REENCRYPTION_OPERATIONS.md`](../../../docs/REENCRYPTION_OPERATIONS.md) §1.2 | Rotation introduces pending key; batches idempotent; drained verification guards decommissioning; re-encryption discovery (count/fetch/usage-snapshot) uses indexed `*_encryption_key_id` equality lookups, not `LIKE` ciphertext scans (`I-2026-0029` / `TB-2026-07-26`). | Admin API tests; re-encryption flow tests; `ezkey-core` unit tests (`EncryptionEntityListenerTest`, `ReencryptionServiceTest`); elective `ReencryptionFullTriggerConcurrentActivityElectiveTest`. | `in-progress` |
