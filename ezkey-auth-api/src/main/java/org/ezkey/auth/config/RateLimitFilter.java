 ...
 * to the pending authentication and enrollment verification endpoints.
 ...
 * <ul>
 * <li>POST /api/v1/auth-attempts/pending/{enrollmentId}</li>
 * <li>POST /api/v1/enrollments/verify</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Pending: By enrollment ID or client IP (configurable)</li>
 * <li>Verify: By client IP only</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class RateLimitFilter implements Filter {
     ...
     */
    private RateLimitResult checkRateLimit(String requestUri, String requestMethod, HttpServletRequest request) {
    ...
    /**
     * Extracts client IP address from HTTP request, handling proxy headers with security considerations.
     * <p>
     ...
     * </p>
     * <p>
     * Security Warning: X-Forwarded-For and X-Real-IP headers can be easily spoofed by clients.
